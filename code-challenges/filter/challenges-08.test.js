...
------------------------------------------------------------------------------------------------ */
//https://stackoverflow.com/questions/52028403/filter-array-of-strings-keeping-only-ones-starting-with-vowels  - helped figure this one out
...
const notInFirstArray = (forbiddenValues, arr) => {
  const testArr = arr.filter(function(item) {
