...
const mapCurrentEvents = () => {
  return currentEvents.news.map(index => new Event(index))
}
...
------------------------------------------------------------------------------------------------ */
//https://dev.to/navi/comment/45bn talks through how to use reduce with split to reverse a string
// I think the reveral actually happens by switching the val and acc
